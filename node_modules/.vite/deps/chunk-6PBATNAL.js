import {
  ...
  $aeb8be23c2978fc5$export$1a38b4ad7f578e1d,
...
import {
  ...
  string,
  type
} from "./chunk-HBS2FB63.js";
import {
  require_react_dom
} from "./chunk-VW5RZSNW.js";
import {
  require_jsx_runtime
} from "./chunk-OUEJEUDF.js";
import {
  require_react
...
// node_modules/react-stately/dist/private/table/useTreeGridState.mjs
...
var $c7bb87e55e1ab755$export$de9feff04fda126e = class {
  ...
  isDisabled(item) {
    var _a;
    return this.disabledBehavior === "all" && (((_a = item.props) == null ? void 0 : _a.isDisabled) || this.disabledKeys.has(item.key));
  }
...
function $e9c0503d101e30f9$export$f6b86a04e5d66d90(props, state, ref) {
  ...
  let delegate = (0, import_react10.useMemo)(() => keyboardDelegate || new (0, $c7bb87e55e1ab755$export$de9feff04fda126e)({
  ...
  let onFocus = (0, import_react10.useCallback)((e2) => {
  ...
  let navDisabledHandlers = (0, import_react10.useMemo)(() => ({
...
function $fb95af427cd4e876$export$25bceaac3c7e4dc7(props, state, ref) {
  ...
  let { direction } = (0, $2eb8e6d23f3d0cb0$export$43bb16f9c6d9e3f7)();
  let disabledBehavior = state.selectionManager.disabledBehavior;
  let delegate = (0, import_react11.useMemo)(() => keyboardDelegate || new (0, $0048eb146240e3fa$export$da43f8f5cb04028d)({
    collection: state.collection,
    disabledKeys: state.disabledKeys,
    disabledBehavior,
    ref,
  ...
  let sortDescription = (0, import_react11.useMemo)(() => {
    var _a;
...
var TableContext = (0, import_react15.createContext)(null);
function useTableContext() {
  const context = (0, import_react15.useContext)(TableContext);
  if (context === null) {
    throw new Error("TableContext not found");
  }
  return context;
}
var VirtualizerContext = (0, import_react15.createContext)(null);
function useVirtualizerContext() {
  const context = (0, import_react15.useContext)(VirtualizerContext);
  if (context === null) {
    throw new Error("VirtualizerContext not found");
  }
  return context;
}
var TableRowContext = (0, import_react15.createContext)(null);
function useTableRowContext() {
  const context = (0, import_react15.useContext)(TableRowContext);
  if (context === null) {
...
var ResizeStateContext = (0, import_react15.createContext)(null);
function useResizeStateContext() {
  const context = (0, import_react15.useContext)(ResizeStateContext);
  if (context === null) {
...
function Resizer(props, forwardedRef) {
  ...
  const layout = (0, import_react15.useContext)(ResizeStateContext);
  useVirtualizerContext();
  const stringFormatter = $cf2482eff2eeeec2$export$f12b703ca79dfbb1(localizedMessages);
  const {
    direction
  } = $2eb8e6d23f3d0cb0$export$43bb16f9c6d9e3f7();
  const [isPointerDown, setIsPointerDown] = (0, import_react15.useState)(false);
  let t0;
  let t1;
  if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
    t0 = () => {
...
var _Resizer = import_react15.default.forwardRef(Resizer);
...
function TableView(props) {
  ...
  let dragHooksProvided = (0, import_react15.useRef)(isTableDraggable);
  let dropHooksProvided = (0, import_react15.useRef)(isTableDroppable);
  ...
  let [isInResizeMode, setIsInResizeMode] = (0, import_react15.useState)(false);
  let [, setIsResizing] = (0, import_react15.useState)(false);
  let domRef = (0, import_react15.useRef)(null);
  let headerRef = (0, import_react15.useRef)(null);
  let bodyRef = (0, import_react15.useRef)(null);
  let styleProps = useStyleProps(props);
  let layout = (0, import_react15.useMemo)(() => new TableViewLayout({
  ...
  let preview = (0, import_react15.useRef)(null);
  ...
  let [headerMenuOpen, setHeaderMenuOpen] = (0, import_react15.useState)(false);
  let [headerRowHovered, setHeaderRowHovered] = (0, import_react15.useState)(false);
  let renderWrapper = (0, import_react15.useCallback)((parent, reusableView, children, renderChildren2) => {
  ...
  let renderView = (0, import_react15.useCallback)((type3, item) => {
    switch (type3) {
      case "header":
      case "rowgroup":
      case "section":
  ...
  let [isVerticalScrollbarVisible, setVerticalScollbarVisible] = (0, import_react15.useState)(false);
  let [isHorizontalScrollbarVisible, setHorizontalScollbarVisible] = (0, import_react15.useState)(false);
  let viewport = (0, import_react15.useRef)({
    x: 0,
    y: 0,
    width: 0,
    height: 0
  });
  let onVisibleRectChange = (0, import_react15.useCallback)((rect) => {
  ...
  let persistedKeys = (0, import_react15.useMemo)(() => {
...
function TableVirtualizer(props) {
  ...
  let [tableWidth, setTableWidth] = (0, import_react15.useState)(0);
  ...
  const getDefaultWidth = (0, import_react15.useCallback)(({
    props: {
      hideHeader,
      isSelectionCell,
      showDivider,
  ...
  const getDefaultMinWidth = (0, import_react15.useCallback)(({
    props: {
  ...
  let state = $51e619e0f141c3ec$export$1505db82fe357e65({
    ...
    persistedKeys,
    layoutOptions: (0, import_react15.useMemo)(() => ({
  ...
  let onVisibleRectChange = (0, import_react15.useCallback)((rect_0) => {
    state.setVisibleRect(rect_0);
  }, [state]);
  let onVisibleRectChangeMemo = (0, import_react15.useCallback)((rect_1) => {
  ...
  let onScroll = (0, import_react15.useCallback)(() => {
    if (bodyRef.current && headerRef.current) {
  ...
  let resizingColumn = (0, import_react15.useMemo)(() => ({
...
function TableColumnHeader(props) {
  ...
  let slots = (0, import_react15.useMemo)(() => {
    return {
      text: {
        color: "inherit",
        weight: "medium",
...
function ResizableTableColumnHeader(props) {
  ...
  let ref = (0, import_react15.useRef)(null);
  let triggerRef = (0, import_react15.useRef)(null);
  let resizingRef = (0, import_react15.useRef)(null);
  let {
    state,
    onResizeStart,
    onResize,
...
function TableRow(props) {
  ...
  let dropIndicatorRef = (0, import_react15.useRef)(null);
  if (isTableDroppable) {
  ...
  let dragButtonRef = (0, import_react15.useRef)(null);
  let {
...
function CellContents(props) {
  ...
  const element = import_react15.Children.only(children);
  return (0, import_jsx_runtime11.jsx)(SlotProvider, {
    slots,
    children: (0, import_react15.cloneElement)(element, $bbaa08b3cd72f041$export$9d1611c77c2fe928(element.props, attributes))
  });
}
...
function BreadcrumbItem(props) {
  ...
  let {
    itemProps
  } = $9db6b1f57564cbf4$export$452b38fce62c9384(t1, ref);
  const {
    hoverProps,
    isHovered
  } = $e969f22b6713ca4a$export$ae780daf29e6d456(props);
  ...
  if ($[4] !== itemProps || $[5] !== hoverProps) {
    t3 = $bbaa08b3cd72f041$export$9d1611c77c2fe928(itemProps, hoverProps);
    $[4] = itemProps;
    $[5] = hoverProps;
    $[6] = t3;
  } else {
  ...
  let t10;
  if ($[23] !== t8 || $[24] !== t9) {
    t10 = (0, import_jsx_runtime19.jsxs)(import_react17.Fragment, {
      children: [t8, t9]
    });
    $[23] = t8;
    $[24] = t9;
...
function Breadcrumbs(props, ref) {
  ...
  let listRef = (0, import_react17.useRef)(null);
  let [menuIsOpen, setMenuOpen] = (0, import_react17.useState)(false);
  ...
  let updateOverflow = (0, import_react17.useCallback)(() => {
  ...
  let lastChildren = (0, import_react17.useRef)(null);
  $c4867b2f328c2698$export$e5c5a5f917a5871c(() => {
  ...
  let breadcrumbItems = contents.map((child_0, index) => {
    ...
    return (0, import_jsx_runtime19.jsx)("li", {
      ...
      children: (0, import_react17.createElement)(BreadcrumbItem, {
        ...child_0.props,
        isCurrent,
        isDisabled,
        key: key_0,
...
var _Breadcrumbs = (0, import_react17.forwardRef)(Breadcrumbs);
...
var NotFoundErrorBoundaryInner = class extends import_react18.default.Component {
  constructor(props) {
    super(props);
    this.state = {
      notFound: false,
...
function useItemData(args) {
  ...
  const locationsForTreeKey = (0, import_react18.useMemo)(() => {
    var _args$slug9;
  ...
  const localTreeKey = (0, import_react18.useMemo)(() => getTreeKey(locationsForTreeKey, rootTree !== null && rootTree !== void 0 ? rootTree : /* @__PURE__ */ new Map()), [locationsForTreeKey, rootTree]);
  const tree = (0, import_react18.useMemo)(() => {
  ...
  return useData((0, import_react18.useCallback)(() => {
...
function CollectionPage(props) {
  ...
  const [searchTerm, setSearchTerm] = (0, import_react18.useState)(t0);
  let t1;
  if ($[2] !== router) {
    t1 = (value) => {
      setSearchTerm(value);
...
function CollectionPageHeader(props) {
  ...
  const [searchVisible, setSearchVisible] = (0, import_react18.useState)(isAboveMobile);
  ...
  (0, import_react18.useEffect)(t2, t3);
  let t4;
...
function CollectionTable(props) {
  ...
  let [sortDescriptor, setSortDescriptor] = (0, import_react18.useState)({
    column: SLUG,
    direction: "ascending"
  });
  ...
  const entriesWithStatus = (0, import_react18.useMemo)(() => {
  ...
  const mainFiles = useData((0, import_react18.useCallback)(async () => {
  ...
  const entriesWithData = (0, import_react18.useMemo)(() => {
...
var AppSlugContext = (0, import_react18.createContext)(void 0);
var AppSlugProvider = AppSlugContext.Provider;
function InstallGitHubApp(props) {
  const $ = c(18);
  const router = useRouter();
  const appSlugFromContext = (0, import_react18.useContext)(AppSlugContext);
  let t0;
...
function ForkRepoDialog(props) {
  ...
  const appSlug = (0, import_react18.useContext)(AppSlugContext);
...
var HeaderBreadcrumbs = (0, import_react18.memo)((props) => {
  const $ = c(5);
  let t0;
  if ($[0] !== props.items) {
    let t12;
...
function useHasChanged(args) {
  ...
  const [hasChanged, setHasChanged] = (0, import_react18.useState)(false);
...
function useYJsValue(schema2, type3) {
  ...
  t0 = t5;
  const thing = t0;
  return (0, import_react18.useSyncExternalStore)(thing.subscribe, thing.getSnapshot, thing.getSnapshot);
}
...
function usePreviewProps(schema2, setState, state) {
  return (0, import_react18.useMemo)(() => createGetPreviewProps(schema2, setState, () => void 0), [schema2, setState])(state);
}
function usePreviewPropsFromY(schema2, map4, state) {
  const yjsInfo = useYjs();
  return (0, import_react18.useMemo)(() => createGetPreviewPropsFromY(schema2, map4, yjsInfo.awareness), [map4, schema2, yjsInfo.awareness])(state);
}
...
function ItemPageInner(props) {
  ...
  const currentBranch = useCurrentBranch();
  const repoInfo = useRepoInfo();
  const [forceValidation, setForceValidation] = (0, import_react18.useState)(false);
  let t2;
  ...
  (0, import_react18.useEffect)(t9, t10);
...
function LocalItemPage(props) {
  ...
  const [t2, setState] = (0, import_react18.useState)(t1);
  const {
    state,
  ...
  (0, import_react18.useEffect)(t8, t9);
...
function HeaderActions(props) {
  ...
  const stringFormatter = $cf2482eff2eeeec2$export$f12b703ca79dfbb1(strings);
  const [deleteAlertIsOpen, setDeleteAlertOpen] = (0, import_react18.useState)(false);
  const [duplicateAlertIsOpen, setDuplicateAlertOpen] = (0, import_react18.useState)(false);
  let t0;
  let t1;
  if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
    t1 = {
...
function CreateBranchDuringUpdateDialog(props) {
  ...
  const stringFormatter = $cf2482eff2eeeec2$export$f12b703ca79dfbb1(strings);
  const repoInfo = useRepoInfo();
  const [branchName, setBranchName] = (0, import_react18.useState)("");
...
function ItemPageOuterWrapper(props) {
  ...
  const format = (0, import_react18.useMemo)(() => getCollectionFormat(props.config, props.collection), [props.config, props.collection]);
  const slugInfo = (0, import_react18.useMemo)(() => {
    return {
      slug: props.itemSlug,
      field: collectionConfig.slugField
    };
  }, [collectionConfig.slugField, props.itemSlug]);
  const draftData = useData((0, import_react18.useCallback)(async () => {
    try {
  ...
  const mapData = useData((0, import_react18.useCallback)(() => {
    if (!yjsInfo) return;
  ...
  return (0, import_jsx_runtime20.jsx)(NotFoundBoundary, {
    ...
    children: (0, import_jsx_runtime20.jsx)(ErrorBoundary, {
      ...
      children: (0, import_jsx_runtime20.jsx)(import_react18.Suspense, {
        fallback: (0, import_jsx_runtime20.jsx)(ItemPageShell, {
          ...props,
          children: (0, import_jsx_runtime20.jsx)(Flex, {
            alignItems: "center",
...
function ItemPageWrapper(props) {
  ...
  const deferredDraftData = (0, import_react18.useDeferredValue)(props.draftData);
...
function CreateItemLocal(props) {
  ...
  const [state, setState] = (0, import_react18.useState)((_props$draft$state = (_props$draft = props.draft) === null || _props$draft === void 0 ? void 0 : _props$draft.state) !== null && _props$draft$state !== void 0 ? _props$draft$state : initialState);
  ...
  (0, import_react18.useEffect)(t6, t7);
  let t8;
  if ($[49] !== initialState) {
    t8 = () => {
...
function BranchNotFound(props) {
  ...
  const currentBranch = useCurrentBranch();
  const appShellDataContext = (0, import_react18.useContext)(GitHubAppShellDataContext);
...
function LocalSingletonPage(props) {
  ...
  (0, import_react18.useEffect)(t3, t4);
  let t5;
...
function KeystaticSetup(props) {
  const $ = c(22);
  const [deployedURL, setDeployedURL] = (0, import_react18.useState)("");
  const [organization, setOrganization] = (0, import_react18.useState)("");
...
function KeystaticCloudAuthCallback({
  ...
  const storedState_0 = (0, import_react18.useMemo)(() => {
...
function RedirectToBranch(props) {
  ...
  const {
    data,
    error
  } = (0, import_react18.useContext)(GitHubAppShellDataContext);
  let t0;
  let t1;
...
function AuthWrapper(props) {
  const $ = c(13);
  const [state, setState] = (0, import_react18.useState)("unknown");
  const router = useRouter();
  let t0;
  let t1;
  if ($[0] !== props.config) {
...
function Keystatic(props) {
  ...
  const Wrapper = props.config.storage.kind === "local" ? import_react18.Fragment : RedirectToLoopback;
  let t0;
  if ($[0] !== props.config) {
...
*/
//# sourceMappingURL=chunk-6PBATNAL.js.map
